...
@Log
public class RelationUnidirectionalMappingTest {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * EmployeeInfoBean empInfo1 = new EmployeeInfoBean(); empInfo1.setId(1);
		 * empInfo1.setName("Eshwar"); empInfo1.setDesignation("SD");
		 * 
		 * EmployeeInfoBean empInfo2 = new EmployeeInfoBean(); empInfo2.setId(2);
		 * empInfo2.setName("Eshwar"); empInfo2.setDesignation("Tester");
		 * 
		 * EmployeeInfoBean empInfo3 = new EmployeeInfoBean(); empInfo3.setId(3);
		 * empInfo3.setName("Eshwar"); empInfo3.setDesignation("Designer");
		 * 
		...
		infoBean1.setId(100);
		infoBean1.setName("Abc");
		infoBean1.setDesignation("MD");

		impl.createEmployee(infoBean1);

		EmployeeInfoBean readInfoBean1 = impl.getEmployeeInfoBean(100);

		EmployeeInfoBean infoBean2 = new EmployeeInfoBean();

		infoBean2.setId(200);
		infoBean2.setName("Abc");
		infoBean2.setDesignation("MD");
		infoBean2.setManagerId(readInfoBean1);

		EmployeeInfoBean infoBean3 = new EmployeeInfoBean();
		infoBean3.setId(300);
		infoBean3.setName("Abc");
		infoBean3.setDesignation("MD");
		infoBean3.setManagerId(readInfoBean1);

		impl.createEmployee(infoBean2);
		impl.createEmployee(infoBean3);
